...
- Name: Scenario 2: Verify main navigation functionality
- Location: /app/tests/homepage-and-navigation.spec.ts:15:5

# Error details

```
Error: browserType.launch: Executable doesn't exist at /ms-playwright/webkit_ubuntu20.04_arm64_special-2092/pw_run.sh
╔══════════════════════════════════════════════════════════════════════╗
